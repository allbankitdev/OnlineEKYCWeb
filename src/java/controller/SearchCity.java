...
public class SearchCity extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        JSONArray SearchCityResult = new JSONArray();
        SearchCityResult = dropdowns.GetSearchCity(CityDetails[0],ClientIP);
        if (arg.equals("1")) {
            SearchCityResult = dropdowns.GetSearchCity(CityDetails[0],ClientIP);
        } else if (arg.equals("2")) {
            SearchCityResult = dropdowns.getBrgyList(CityDetails[0],ClientIP);
        }

        response.getWriter().print(SearchCityResult);
    }
