...
public class AuditLog {
    ...
    public static String AddAuditLog(String Request, String URL, String ClientIP) {
        String returno = "";
        Connection con = null;
        try {
            ...
            UpdateLOGSQuery = "insert into APIauditlogs (REQUEST,REQUESTDATETIME,URL,REQUESTINGIP) values(?,GetDate(),?,?)";
            ...
            UpdateLOGS.setString(3, ClientIP);
