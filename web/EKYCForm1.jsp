...
<html lang="en">
    ...
    <body id="page-top" onload="ToggleModalTips()">
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <button type="button" data-toggle="modal" data-target="#AddMaintenanceModal">asdf</button>                </div>
                <br>
                            ...
                            <div class="col-sm-8">
                                <div class="modal-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm">
                                            s<img class="img-fluid d-block mx-auto" src="Bootstrap/assets/img/products/CASHCARDLogo.png" alt="..." />
                                        </div>
